...
export const BURGERKING_SCENARIO: ScenarioScript = {
  ...
  steps: [
    ...
    },
    {
      id: "burger-choice",
      instruction: "와퍼를 골라요",
      helpText: "오늘은 와퍼 세트가 목표예요. 와퍼는 버거킹의 대표 버거예요.",
      layout: "grid",
      choices: [
        { id: "whopper", label: "와퍼", sublabel: "8,400원", emoji: "🍔" },
        {
          id: "quattrocheese",
          label: "콰트로치즈와퍼",
          sublabel: "10,100원",
      ...
      correctChoiceId: "whopper",
      successMessage: "와퍼! 맛있겠네요.",
      hintMessage: "왼쪽 위 '와퍼' 카드를 눌러보세요.",
    },
    {
      id: "set-or-single",
