...
export function StarbucksCardInsert({
  step,
  rejectedChoiceId,
  idleHintActive,
  onChoice,
  ...
  // Auto-advance after 3 seconds — matches real kiosk POS behavior.
  useEffect(() => {
    const t = setTimeout(() => {
      onChoice(next.id);
    }, 3000);
  ...
  return (
    ...
    >
      ...
      {/* Manual advance — also auto-advances above */}
      <div
        css={css`
